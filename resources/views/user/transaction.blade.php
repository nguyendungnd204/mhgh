                ...
                <form action="" method="POST" class="p-6 ">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="card_type" id="card_type"
                            ...
                            <option value="10000" {{ old('card_type') == 'viettel' ? 'selected' : '' }}>Viettel</option>
                    ...
                    <div class="mb-4">
                        <label for="amount" class="block text-gray-300 text-sm font-medium mb-2">Chọn mệnh giá thẻ</label>
                        <select name="amount" id="amount"
                            class="w-full bg-gray-800/50 border border-gold/30 rounded-lg px-4 py-3 text-white focus:border-gold focus:ring-2 focus:ring-gold/20 focus:outline-none transition-all duration-200"
                            required>
                            <option value="" {{ old('amount') == '' ? 'selected' : '' }}>-- Chọn mệnh giá --</option>
                            <option value="10000" {{ old('amount') == '10000' ? 'selected' : '' }}>10.000đ</option>
                            <option value="20000" {{ old('amount') == '20000' ? 'selected' : '' }}>20.000đ</option>
                            <option value="30000" {{ old('amount') == '30000' ? 'selected' : '' }}>30.000đ</option>
                            <option value="50000" {{ old('amount') == '50000' ? 'selected' : '' }}>50.000đ</option>
                            <option value="100000" {{ old('amount') == '100000' ? 'selected' : '' }}>100.000đ</option>
                            <option value="200000" {{ old('amount') == '200000' ? 'selected' : '' }}>200.000đ</option>
                            <option value="500000" {{ old('amount') == '500000' ? 'selected' : '' }}>500.000đ</option>
                        </select>
                        @error('amount')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
