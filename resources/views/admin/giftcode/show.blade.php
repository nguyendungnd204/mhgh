...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="bg-white shadow-md rounded-lg">
        <div class="p-6">
            ...
            <p class="mb-2"><strong class="font-semibold">Số lượt đã sử dụng: </strong>{{ $giftCode->used_count ?? '-' }}</p>
            <p class="mb-4"><strong class="font-semibold">Trạng thái: </strong>
                <span class="inline-block px-2 py-1 text-xs font-semibold rounded-full {{ $giftCode->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
